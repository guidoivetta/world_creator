class Builder{
  ...
  setName(input){
    ...
    switch(input){
      ...
      case "delFromTo":
        ...
        break;
      case "y":
        if (this.tool == "delFromTo" && this.sel1 != null && this.sel2 != null){
          this.deleteFromTo();
        }
        else if (this.tool == "placeFromTo" && this.sel1 != null && this.sel2 != null){
          this.placeFromTo();
        }
        break;
      case "n":
  ...
  drawOnMouse(){
    ...
    if (this.tool == "place"){
      typewriter.type(this.object.char,this.cursorX-1,this.cursorY-1,this.object.col);
    }
